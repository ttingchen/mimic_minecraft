...
float p[] = { 151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36, 103, 30, 69, 142, 8, 99, 37, 240, 21, 10,
...
float perlin(float x, float y, float z) {
		...
		int X = floorX & 255, Y = floorY & 255, Z = floorZ & 255;
